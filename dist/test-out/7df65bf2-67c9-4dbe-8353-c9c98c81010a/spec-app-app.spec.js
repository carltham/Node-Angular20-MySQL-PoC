import "./chunk-NFWN3KKD.js";
import {
  EVENT_MANAGER_PLUGINS,
  EventManagerPlugin,
  init_dom_renderer
} from "./chunk-UQAPRCJF.js";
import {
  CommonModule,
...
var init_app = __esm({
  "angular:jit:template:src/app/app.html"() {
    app_default = '<header class="container">\n  <h1>Noprob IT, sample Node / Angular 20 / MySQL Prof of Concept</h1>\n  <nav>\n    <a routerLink="/">Home</a>\n    <a routerLink="/users">Users</a>\n  </nav>\n</header>\n<main class="container"><router-outlet /></main>';
  }
});
...
var init_app3 = __esm({
  "src/app/app.ts"() {
    ...
    App = class App2 {
      constructor() {
        this.title = "Node-Angular20-MySQL-PoC";
      }
    };
    App = __decorate([
      Component({
  ...
  "src/app/app.spec.ts"(exports) {
    ...
    describe("App", () => {
      ...
      it("should render title", () => {
        ...
        expect(compiled.querySelector("h1")?.textContent).toContain("Prof of Concept");
      });
    });
  }
});
